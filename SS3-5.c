...
int main() {
    ...
    printf("| %-3d | %-20s | %-4d | %-11s | %-25s |\n", 5, "Nguyen Van E", 20, "0904488485", "env@rikkeiacademy.com");
    printf("| %-3d | %-20s | %-4d | %-11s | %-25s |\n", 6, "Nguyen Van F", 23, "0904488486", "fnv@rikkeiacademy.com");
    printf("| %-3d | %-20s | %-4d | %-11s | %-25s |\n", 7, "Nguyen Van G", 19, "0904488487", "gnv@rikkeiacademy.com");
    printf("| %-3d | %-20s | %-4d | %-11s | %-25s |\n", 8, "Nguyen Van H", 21, "0904488488", "hnv@rikkeiacademy.com");
